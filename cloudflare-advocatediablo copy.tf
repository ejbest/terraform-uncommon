...
# MX Records
# https://mailadmin.zoho.com/cpanel/home.do#domains/advocatediablo.com/emailConfig/mx
...
# SPF Records 
# https://mailadmin.zoho.com/cpanel/home.do#domains/advocatediablo.com/emailConfig/spf

resource "cloudflare_record" "advocatediablo-spf-zoho" {
  zone_id = local.cloudflare_zone_id
  name    = "@"
...
# DKIM Records
# https://mailadmin.zoho.com/cpanel/home.do#domains/advocatediablo.com/emailConfig/dkim/dkim-listing

resource "cloudflare_record" "advocatediablo-dkim-zoho" {
  zone_id = local.cloudflare_zone_id
  name    = "s1._domainkey"
...
# DMARC Records
# https://mailadmin.zoho.com/cpanel/home.do#domains/advocatediablo.com/emailConfig/dmarc

resource "cloudflare_record" "advocatediablo-dmarc-zoho" {
  zone_id = local.cloudflare_zone_id
  name    = "_dmarc"
  content = "v=DMARC1; p=quarantine; rua=mailto:ej@advocatediablo.com; ruf=mailto:ej@advocatediablo.com; sp=quarantine; adkim=r; aspf=r"
  type    = "TXT"
  ttl     = 3600
}
